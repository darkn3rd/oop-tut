...
print('Triangle (base=%d, height=%d) area is: %6.1f' % (4, 5, triangleObject.calculateArea()))
print('Rectangle (width=%d, height=%d) area is: %4.1f' % (4, 5, rectangleObject.calculateArea()))
print('Circle (radius=%d) area is: %16.1f' % (4, cirleObject.calculateArea()))