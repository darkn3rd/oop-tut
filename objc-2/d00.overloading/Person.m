...
/******* INITIALIZERS *******/
- (id) init {
   if (self = [super init]) { [self info]; }
   return self;
}

- (id) initWithAge: (NSNumber *) age {
   if (self = [super init]) { _age = age; [self info]; }
   return self;
}
- (id) initWithName: (NSString *) name {
   if (self = [super init]) { _name = name; [self info]; }
   return self;
}

- (id) initWithName: (NSString *) name age:(NSNumber *) age{
   if (self = [super init]) { _name = name; _age = age; [self info]; }
   return self;
}
